<template>
  <div
    v-if="
      $store.state.md_tick.tick &&
      $store.state.list.trademark &&
      $store.state.list.Location
    "
    class="list_tick"
  >
    <div
    ...
    >
      <div class="menat_iteam">
        <div
          v-if="$store.getters['list/trademark_id'](item.trademark)"
          class="logo"
        >
          <img
            width="50"
          ...
          <p>
            {{
              $store.getters["list/trademark_id"](item.trademark)[0] ==
              undefined
                ? ""
        ...
        <div
          v-if="$store.getters['list/location_id'](item.location_departure)[0]"
          class="location"
        >
          Từ
          {{
