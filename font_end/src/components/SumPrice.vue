  ...
  setup() {
    const next = () => {
      if (store.state.list.search.round_trip == "false") {
        if (store.state.list.my_ticker.id_chair[0]) {
          router.push({
            name: "booking",
            query: {
          ...
          store.state.err_choseseat.chair1 = true;
        }
      } else {
        if (
          store.state.list.my_ticker.id_chair[1] &&
          store.state.list.my_ticker.id_chair[0]
        ) {
          router.push({
            name: "booking",
            query: {
          ...
          if (!store.state.list.my_ticker.id_chair[1]) {
            store.state.err_choseseat.chair2 = true;
          }
        }
      }
    };
