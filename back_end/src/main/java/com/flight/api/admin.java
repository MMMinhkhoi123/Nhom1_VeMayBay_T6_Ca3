...
public class admin {
	...
	public ResponseEntity<location_reponse> create_location(@RequestBody Optional<location_request> location) {
		return locationservice.save(location.get());
	}
	@GetMapping("/location")
	...
	public ResponseEntity<location_reponse> delete_location(@PathVariable(value = "id",required = true) Optional<Long> idlocation) {
	...
	public ResponseEntity<trademark_reponse> create_trademark(@RequestBody Optional<trademark_request> trademark) {
		return trademarkservice.save(trademark.get());
	}
